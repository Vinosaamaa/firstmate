...
[docs/pi-supervision-branch.md](pi-supervision-branch.md) owns grant, row eligibility, and dispatch architecture, and every other harness keeps the wake-to-main path unchanged.
