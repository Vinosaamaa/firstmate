...
state/               runtime records and signals; gitignored
  ...
  branch-session/ .branch-session .branch-mirror-cursor .branch-wake-reservation  the branch's persistent conversation, its pointer, dialog-mirror cursor, and exact queue-batch reservation; extension-owned (docs/pi-supervision-branch.md)
