...
firstmate is the command layer, not the workshop: Fastlane owns focused validation, CI belongs to the forge, explicitly requested no-mistakes runs own their pipeline, and merge policy belongs to the configured authority.
