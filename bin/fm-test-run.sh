...
family_for_basename() {
  case "$1" in
    ...
    fm-transition-lib.test.sh|fm-workspace.test.sh|\
    ...
    fm-secondmate-workspace.test.sh|\
    ...
    fm-herdr-session-cleanup.test.sh|fm-send-inbox.test.sh|fm-send-resolve-key.test.sh|fm-send-strict.test.sh|\
