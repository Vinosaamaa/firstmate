...
test_view_renders_snapshot() {
  ...
  assert_contains "$view" "bin/fm-send.sh " \
    "view should show names-first secondmate send guidance"
  assert_contains "$view" "'<request>' - read status/doc return channel" \
    "view should retain the secondmate return-channel guidance"
